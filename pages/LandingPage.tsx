...
const LandingPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    login(email, isLoginView ? undefined : name);
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-10 sm:pt-20 pb-16 sm:pb-24 grid lg:grid-cols-2 gap-8 sm:gap-16 items-center">
        <motion.div 
          ...
          className="space-y-8"
        >
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold font-poppins text-slate-900 leading-[1.1]">
            Study together, <br />
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-6 pt-4">
            <div className="space-y-1">
              <span className="text-xl sm:text-2xl font-bold text-blue-900">5k+</span>
              <p className="text-xs sm:text-sm text-slate-500">Active Students</p>
            </div>
            <div className="space-y-1">
              <span className="text-xl sm:text-2xl font-bold text-blue-900">12k+</span>
              <p className="text-xs sm:text-sm text-slate-500">Resources Shared</p>
            </div>
            <div className="space-y-1">
              <span className="text-xl sm:text-2xl font-bold text-blue-900">45k+</span>
              <p className="text-xs sm:text-sm text-slate-500">Questions Solved</p>
            </div>
          </div>
        ...
        <motion.div 
          ...
          className="bg-white p-6 sm:p-10 rounded-3xl shadow-2xl border border-slate-100 max-w-md mx-auto lg:mr-0"
        >
