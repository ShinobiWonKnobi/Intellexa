...
const ShareModal: React.FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onClose();
    setFormData({ title: '', description: '', course: POPULAR_COURSES[0], customCourse: '', tags: '', link: '' });
                ...
                {!isOtherCourse ? (
                  ...
                  <div className="flex gap-2">
                    <input 
                      ...
                      className="flex-1 px-5 py-3.5 rounded-2xl bg-slate-50 border-none focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none transition-all text-sm font-bold"
