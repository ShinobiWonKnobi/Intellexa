...
const AppContent: React.FC = () => {
  ...
  return (
    <Layout activeTab={activeTab} onTabChange={handleTabChange} onSearch={handleSearch}>
      ...
      <div className="fixed bottom-20 sm:bottom-6 right-4 sm:right-6 flex flex-col gap-2 sm:gap-3 z-40 items-end">
        {/* Share Resource FAB */}
        <div className="flex items-center gap-3 group">
          ...
          <button 
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white w-11 h-11 sm:w-14 sm:h-14 rounded-2xl shadow-2xl flex items-center justify-center transition-all hover:scale-110 active:scale-95 border-2 border-white/20"
        ...
        <div className="flex items-center gap-3 group">
          ...
          <button 
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white w-12 h-12 sm:w-14 sm:h-14 rounded-2xl shadow-2xl flex items-center justify-center transition-all hover:scale-110 active:scale-95 border-2 border-white/20"
            title="Ask Question"
          >
